...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-default-wizard pull-right"),
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-default-wizard pull-left"),
...
//        elmActionBar.append($this.msgBox);
    ...
    var _adjustButton = function($this) {
        ...
        // Finish Button
        if ($this.options.includeFinishButton){
            if (! $this.steps.hasClass('buttonDisabled') || $this.options.enableFinishButton){
